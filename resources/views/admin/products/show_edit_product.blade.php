                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" name="products[{{0}}][active]"
                                                            value = 1
                                                            id="active"
                                                            class="switchery" data-color="success"
                                                                    {{$product -> active  == 1 ? "checked" : ""}}/>
                                                                    @error("products.0.active")
                                                                    <span class="text-danger"> {{$message}}</span>
                                                                    @enderror
                                                                <label for="active"
                                                        ...
                                                        <div role="tabpanel" class="tab-pane {{$key == 0 ? "active" : ""}}" id="home{{$key}}" aria-labelledby="home-tab" aria-expanded="{{$key == 0 ? "true" : "false"}}">
                                                            <div class="row all_data">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="products">حالت المنتج (جديد او مستعل)</label>
                                                                        <select name="products[{{$key + 1}}][state]" class=" form-control">
                                                                            <optgroup label="اختر حالت المنتج">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group mt-1">
                                                                        <input type="checkbox" name="products[{{$key + 1}}][active]"
                                                                        value = 1
                                                                        id="active"
                                                                        class="switchery" data-color="success"
                                                                                {{$val -> active  == 1 ? "checked" : ""}}/>
                                                                                @error("products." . ($key + 1) . ".active")
                                                                                <span class="text-danger"> {{$message}}</span>
                                                                                @enderror
                                                                            <label for="active"
                                                                                class="card-title ml-1"> الحالة </label>
