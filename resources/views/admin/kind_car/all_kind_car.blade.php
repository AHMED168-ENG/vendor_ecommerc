    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title"> انواع السيارات  </h3>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">جميع انواع السيارت </h4>
                                ...
                                <div class="card-body card-dashboard">
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            @else
                                                @foreach ($kind_car as $item)
                                                    <tr>
                                                        <td>{{$item -> name}}</td>
                                                        <td><img style="width:50px;height:50px" src="{{asset("public/asset/admin/images/products_image/car_photo" . "/" . $item -> car_photo)}}" alt=""></td>
                                                        <td><img style="width:50px;height:50px" src="{{asset("public/asset/admin/images/products_image/car_logo_photo/" . "/" . $item -> car_logo_photo)}}" alt=""></td>
                                                        <td>{{$item -> active == 0 ? "closed" : "open"}}</td>
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                aria-label="Basic example">
                                                                <a href="{{Route('edit_kind_car' , $item -> id)}}"
                                                                class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">تعديد</a>
                                                                <a href="{{Route("delete_kind_car" , $item->id)}}"
                                                                class="btn btn-outline-danger btn-min-width box-shadow-3 mr-1 mb-1">حذف</a>
                                                                <a href="{{Route("active_kind_car" , $item->id)}}"
