                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{route('add_language')}}" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{old("shourtcut")}}" id="name"
                                                               class="form-control"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="direction" class="select2 form-control">
                                                            <optgroup label="من فضلك أختر اتجاه اللغة ">
                                                                <option value="ltr" {{old("direction") == "ltr" ? "selected" : ""}} >من اليسار الي اليمين</option>
                                                                <option value="rtl" {{old("direction") == "rtl" ? "selected" : ""}}>من اليمين الي اليسار</option>
                                                            </optgroup>
                                                        </select>
                                                        @error('direction')
                                                            <span class="text-danger">{{$message}}</span>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group mt-1">
                                                        <input type="checkbox" value="1" {{old("active") == "on" ? "checked" : ""}} name="active"
                                                               id="switcheryColor4"
