    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title"> جميع الاسليدرس الخاصه بالموقع</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{Route("dashpored")}}">الرئيسية</a>
                            </li>
                            <li class="breadcrumb-item active"> الاسليدرس
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">جميع الاسليدرس </h4>
                                        ...
                                        <tbody>
                                            ...
                                            @else
                                                @foreach ($sliders as $item)
                                                    <tr>
                                                        <td class="over_flow"><p>{{$item -> title}}</p></td>
                                                        <td class="over_flow"><p >{{$item -> info}}</p></td>
                                                        <td><img style="width:50px;height:50px" src="{{asset("public/asset/admin/images/sliders_photo/" . "/" . $item -> img)}}" alt=""></td>
                                                        <td>{{$item -> page}}</td>
                                                        <td>{{$item -> active == 0 ? "closed" : "open"}}</td>
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                aria-label="Basic example">
                                                                <a href="{{Route('edit_sliders' , $item -> id)}}"
                                                                class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">تعديد</a>
                                                                <a href="{{Route("delete_sliders" , $item->id)}}"
                                                                class="btn btn-outline-danger btn-min-width box-shadow-3 mr-1 mb-1">حذف</a>
                                                                <a href="{{Route("active_sliders" , $item->id)}}"
