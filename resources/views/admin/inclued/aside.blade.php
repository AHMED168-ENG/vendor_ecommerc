...
<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item active"><a href="{{Route("dashpored")}}"><i class="la la-mouse-pointer"></i><span
            ...
            <li class="nav-item"><a href=""><i class="la la-home"></i>
                ...
                <span
                    class="badge badge badge-info badge-pill float-right mr-2">{{show_active_language()->count()}}</span>
            </a>
                <ul class="menu-content">
                    <li class="{{request() -> url() == route("all_lang") ? 'active' : '' }}"><a class="menu-item" href="{{Route('all_lang')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض اللغات </a>
                    </li>
                    <li class="{{request() -> url() == route("show_page") ? 'active' : '' }}"><a class="menu-item" href="{{Route('show_page')}}" data-i18n="nav.dash.crypto">أضافة لغه جديده
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    <li class="{{request() -> url() == route("all_catigory") ? "active" : ""}}"><a class="menu-item" href="{{route('all_catigory')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li class="{{request() -> url() == route("add_catigory") ? "active" : ""}}"><a class="menu-item" href="{{route('add_catigory')}}" data-i18n="nav.dash.crypto">أضافة
                        قسم جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <span
                    class="badge badge badge-success badge-pill float-right mr-2">{{App\models\vindoers\vindoers_model::count()}}</span>
            </a>
                <ul class="menu-content">
                    <li class="{{request() -> url() == route("all_vindoer") ? "active" : ""}}"><a class="menu-item" href="{{route("all_vindoer")}}"
                                          data-i18n="nav.dash.ecommerce"> عرض التجار </a>
                    </li>
                    <li class="{{request() -> url() == route("create_vindoer") ? "active" : ""}}"><a class="menu-item " href="{{route("create_vindoer")}}" data-i18n="nav.dash.crypto">أضافة تاجر
                         </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <span
                    class="badge badge badge-warning  badge-pill float-right mr-2">{{App\models\main_catigory\catigors_models::SupCatigoryDefault()->get()->count()}}</span>
            </a>
                <ul class="menu-content">
                    <li class="{{request() -> url() == route("all_subCatigory") ? "active" : ""}}"><a class="menu-item" href="{{route("all_subCatigory")}}"
                                          data-i18n="nav.dash.ecommerce">عرض الكل </a>
                    </li>
